  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl p-6 max-w-3xl w-full max-h-[90vh] overflow-y-auto">
        ...
        {/* Payment Status Card */}
        <div className={`rounded-xl p-5 border-2 mb-6 ${statusColor}`}>
          <div className="flex justify-between items-start">
            <div>
              <p className="text-sm font-medium mb-1 opacity-80">Payment Status</p>
            ...
            <div className="text-right">
              <p className="text-sm font-medium mb-1 opacity-80">Amount</p>
            ...
            <div className="space-y-3">
              ...
              {payment.reference_no && (
                <div>
                  ...
                  <p className="text-sm font-mono font-semibold text-gray-900 bg-white px-3 py-2 rounded border border-purple-200">
                    {payment.reference_no}
                  </p>
                </div>
              )}
              {payment.stripe_payment_intent_id && (
                <div>
                  ...
                  <p className="text-xs font-mono text-gray-700 bg-white px-3 py-2 rounded border border-purple-200 break-all">
                    {payment.stripe_payment_intent_id}
                  </p>
                </div>
              )}
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-xl p-5 mb-6">
          ...
          <div className="space-y-3">
            ...
            {room && rentPerHead > 0 && (
              <div className="bg-white rounded-lg p-4 border border-green-100">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm font-medium text-gray-700">🏠 Rent (per person)</span>
            ...
            {hasElectronics && (
              <div className="bg-white rounded-lg p-4 border border-green-100">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm font-medium text-gray-700">🔌 Extra Electronics</span>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold text-blue-900">Payment Receipt Available</p>
